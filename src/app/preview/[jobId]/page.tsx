...
import { Download, ExternalLink, ArrowLeft, Loader2, AlertCircle, FileText, CheckCircle2, Sparkles } from 'lucide-react';
        ...
        <div className="z-10 text-center space-y-10 max-w-md">
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-gray-400 text-lg">This usually takes a few seconds</p>
            </div>
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white flex flex-col p-4 md:p-8 h-screen">
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-medium text-green-400">Conversion Complete</span>
